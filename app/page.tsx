    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-gray-950 dark:to-gray-900">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <div>
                <h1 className="font-bold text-xl text-gray-900 dark:text-white">Smart Life Transformers</h1>
                <p className="text-sm text-gray-600 dark:text-gray-400">Talent Accelerator NGO</p>
              </div>
            </motion.div>

            <nav className="hidden md:flex items-center space-x-8">
              <Link href="/" className="text-gray-700 hover:text-blue-600 transition-colors dark:text-gray-300 dark:hover:text-blue-400">
                Home
              </Link>
              <button
        ...
        <div className="container mx-auto text-center">
          <motion.div variants={staggerContainer} initial="initial" animate="animate" className="max-w-4xl mx-auto">
            ...
            <motion.p variants={fadeInUp} className="text-xl text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
              Smart Life Transformers is a talent accelerator NGO dedicated to empowering individuals and communities
              through innovative solutions across multiple sectors.
            </motion.p>
            ...
            <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button variant="outline" size="lg" onClick={() => scrollToSection("mission")} className="dark:border-gray-700 dark:text-gray-50 dark:hover:bg-gray-800">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent flex items-center">
              <div className="text-white p-8 md:p-12 max-w-2xl">
                <h3 className="text-3xl md:text-4xl font-bold mb-4">Transforming Communities Together</h3>
                <p className="text-lg md:text-xl text-gray-200 mb-6">
                  See how our dedicated team works across multiple sectors to create lasting positive impact in
                  communities worldwide.
                </p>
                <Button size="lg" variant="secondary" className="dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600">
      ...
      <section id="branches" className="py-20 px-4 bg-white dark:bg-gray-900">
        <div className="container mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">Our Branches</h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Discover our specialized branches, each dedicated to transforming lives in their respective sectors
      ...
      {/* Mission Section */}
      <section id="mission" className="py-20 px-4 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-900 dark:to-gray-800">
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                At Smart Life Transformers, we believe in the power of innovation to create lasting positive change. Our
                mission is to accelerate talent development and provide sustainable solutions that transform
                communities.
              </p>
              ...
              <div className="aspect-square bg-gradient-to-br from-blue-400 to-purple-500 rounded-3xl p-8 text-white">
                <div className="h-full flex flex-col justify-center">
                  ...
                  <p className="text-blue-100 mb-6">
                    Be part of the transformation. Together, we can create a better future for communities worldwide.
                  </p>
                  <Button variant="secondary" className="self-start dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600" onClick={() => scrollToSection("contact")}>
                    Get Involved
                    <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
                </div>
      ...
      <section id="contact" className="py-20 px-4 bg-white dark:bg-gray-900">
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Ready to transform lives together? Contact us to learn more about our mission and how you can get
              involved.
            </p>
          </motion.div>
          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">info@smartlifetransformers.org</p>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">Transform City, TC 12345</p>
              </div>
            </div>
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">Transforming lives through innovation and talent acceleration.</p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li>
                  <Link href="/slt-energies" className="hover:text-white transition-colors">
                    SLT Energies
                  </Link>
                </li>
                <li>
                  <Link href="/slt-entertainment" className="hover:text-white transition-colors">
                    SLT Entertainment
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <p className="text-gray-400 mb-4">Stay connected with our community impact.</p>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Smart Life Transformers. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
